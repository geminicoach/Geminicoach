...
window.GEMINI_COURSES = {
  ...
  courses: [
    ...
    { slug:"b2-endocrine-hormones", code:"B2", track:"B", title:"Endocrine System / Hormones 101",
      ...
      chapters:[
        { position:1, title:"The Body's Chemical Mail System", subtitle:"The operating system underneath insulin, thyroid, testosterone, and every hormone you will ever study.", minutes:60,
        ...
        { position:2, title:"Mission Control: The Hypothalamus and Pituitary", subtitle:"How a brain region the size of an almond runs the entire endocrine system through one repeating template.", minutes:60,
        ...
        { position:3, title:"The Fuel Manager: Insulin and Blood Sugar", subtitle:"How two opposing hormones hold your blood glucose in a narrow band, and why \"resistance\" almost never means \"not enough insulin.\"", minutes:60,
        ...
        { position:4, title:"The Metabolic Thermostat: Thyroid", subtitle:"If insulin manages fuel minute to minute, the thyroid sets the speed of the whole engine.", minutes:60,
        ...
        { position:5, title:"Stress Chemistry: Adrenaline, Cortisol, and the DHEA Question", subtitle:"Two timescales of stress, one pair of glands, and a quiet precursor that fades with age.", minutes:60,
        ...
        { position:6, title:"The Sex Hormone Network: Testosterone, Estradiol, and the HPG Axis", subtitle:"Both sexes make both. The difference is amount and ratio, not presence.", minutes:60,
        ...
        { position:7, title:"Estradiol's Hidden Job Description: Bone, Brain, Libido, and Joints", subtitle:"The most underrated hormone in the body, in both sexes, and why its reputation got it so wrong.", minutes:60,
        ...
        { position:8, title:"Hunger's Two Voices: Leptin and Ghrelin", subtitle:"The short-term hunger alarm and the long-term fuel gauge, and why appetite is physiology, not character.", minutes:60,
        ...
        { position:9, title:"Build and Repair: Growth Hormone and IGF-1", subtitle:"A command hormone, a downstream effector, and the most reliable lever you already own: deep sleep.", minutes:60,
        ...
        { position:10, title:"Crossed Wires: How Hormones Talk to Each Other", subtitle:"The endocrine system is a web, not a stack of independent pipes.", minutes:60,
        ...
        { position:11, title:"The Four Levers: Sleep, Stress, Nutrition, and Training", subtitle:"The chapter where everything you have learned becomes something you can actually use.", minutes:60,
        ...
        { position:12, title:"The Whole Symphony: Putting Hormones Together", subtitle:"One self-regulating network, seen at last from the conductor's chair.", minutes:60,
