/* Gemini Education: E1 (Energy Systems & Metabolism) FULL exam bank (all question types).
   PARKED until the portal thread upgrades exam.html to render matching / multi-select /
   word-bank / write-in. The live exam (e1-energy-metabolism.js) is an interim MC+TF subset
...
window.GEM_EXAM = {
  ...
  questions: [
    ...
    },
    {
      ...
      "chapter": 1,
      "type": "fill",
      "q": "Adenosine triphosphate is hydrolyzed by adding water to break a phosphoanhydride bond, producing adenosine diphosphate plus a free phosphate group called {{1}}. This reaction is exergonic overall not because the bond itself stored energy, but because the products are more stable than the reactants due to relieved electrostatic repulsion, resonance stabilization, and better {{2}}.",
      "bank": [
        "inorganic phosphate",
        "solvation",
        "creatine",
    ...
    },
    {
      ...
      "chapter": 3,
      "type": "multi",
      "q": "Which of the following statements about lactate are accurate, according to the chapter's correction of the century-old lactic acid myth? Select all that apply.",
      "options": [
        "Lactate, not lactic acid, is the molecule actually produced by muscle during glycolysis",
        "The lactate-forming reaction consumes a hydrogen ion, so it slightly buffers the muscle rather than causing acidosis",
        "Roughly seventy five to eighty percent of lactate produced is reused as fuel or recycled into glucose rather than discarded as waste",
        "Lactate causes the delayed muscle soreness felt one to two days after unfamiliar exercise",
        "Lactate is cleared from the blood within about thirty to sixty minutes of stopping exercise"
      ],
      "answers": [
        0,
        1,
      ...
      "points": 1,
      "explanation": "Muscles produce lactate, not lactic acid, the reaction buffers rather than acidifies, most lactate is reused or recycled, and it clears within about an hour. Delayed onset muscle soreness is caused by mechanical microdamage and inflammation, not by lingering lactate."
    },
    {
      "id": "e1-c4-mc-1",
      "chapter": 4,
    ...
    },
    {
      ...
      "chapter": 4,
      "type": "fill",
      "q": "In the electron transport chain, NADH delivers electrons to Complex I while FADH2 delivers electrons to Complex {{1}}, a lower energy entry point that yields somewhat less ATP per molecule. Oxygen accepts the spent electrons only at Complex {{2}}, where it combines with hydrogen ions to form water.",
      "bank": [
        "II",
        "IV",
        "III",
      ...
      "pairs": [
        {
          ...
          "right": "The exercise intensity at which carbohydrate overtakes fat as the dominant fuel source, described by Brooks and Mercier (1994)"
        },
        {
          "left": "Lactate threshold",
          "right": "The intensity at which lactate production begins to outpace clearance by a wide, rapidly growing margin, reflecting accelerated glycolysis rather than oxygen deprivation"
        },
        {
          "left": "Fatmax",
          "right": "The exercise intensity at which the absolute rate of fat oxidation, in grams per minute, reaches its peak"
        },
        {
          "left": "Maximal lactate steady state",
          "right": "The highest exercise intensity at which blood lactate can be held roughly constant rather than rising continuously"
        }
      ],
      "points": 4
    },
    ...
    },
    {
      ...
      "chapter": 6,
      "type": "match",
      "q": "Match each energy system to the defining feature that distinguishes it.",
      "pairs": [
        {
          "left": "Phosphagen system",
          "right": "Regenerates ATP through a single-step, direct phosphate transfer from creatine phosphate to ADP, requiring no oxygen and lasting about ten seconds at maximal effort"
        },
        {
          "left": "Glycolytic system",
          "right": "Breaks down glucose or glycogen without oxygen, netting two or three ATP per glucose unit, and produces lactate to keep NAD-plus regenerating"
        },
        {
          "left": "Oxidative (aerobic) system",
          "right": "Uses oxygen as the final electron acceptor inside mitochondria to extract roughly thirty to thirty two ATP per glucose, and is the only system that can burn fat"
        }
      ],
      "points": 3
    },
    {
      ...
      "chapter": 6,
      "type": "multi",
      "q": "Which of the following statements accurately describe how the three energy systems interact during a maximal effort, according to Gastin's (2001) reframing? Select all that apply.",
      "options": [
        "All three systems are active from the first instant of effort; only the proportion each contributes changes over time",
        "The phosphagen system is nearly instantaneous, glycolysis peaks around ten to fifteen seconds, and oxidative metabolism keeps rising for one to two minutes",
        "The crossover point, where cumulative aerobic energy overtakes cumulative anaerobic energy in an all-out effort, occurs at roughly seventy five seconds",
        "Once the phosphagen system's ten second window ends, it shuts off completely and contributes nothing for the rest of the effort",
        "Aerobic contribution to a two hundred meter sprint has been measured at roughly twenty nine percent, far from zero"
      ],
      "answers": [
        0,
        1,
      ...
      "scoring": "all_or_nothing",
      "points": 1,
      "explanation": "The three systems overlap continuously rather than switching off. The phosphagen, glycolytic, and oxidative ramps rise on different timescales, the crossover to aerobic majority arrives near seventy five seconds, and even a short sprint draws a real aerobic contribution. No system, including the phosphagen system, is ever fully inactive once engaged."
    },
    {
      "id": "e1-c7-mc-1",
      "chapter": 7,
    ...
    },
    {
      ...
      "chapter": 8,
      "type": "multi",
      "q": "Which of the following are accurately graded as real but modest effects in the chapter's honest accounting of daily energy expenditure? Select all that apply.",
      "options": [
        "Excess post-exercise oxygen consumption (EPOC), which typically amounts to only tens of kilocalories for sustainable training",
        "Adaptive thermogenesis during sustained caloric restriction, on the order of about one hundred kilocalories per day in normal weight subjects",
        "Non-exercise activity thermogenesis (NEAT), which can vary by up to two thousand kilocalories per day between similarly sized people",
        "The claim that eating many small meals instead of fewer large meals meaningfully raises the thermic effect of food",
        "The claim that starvation mode can halt fat loss entirely regardless of caloric deficit size"
      ],
      "answers": [
        0,
        1,
      ...
      "scoring": "all_or_nothing",
      "points": 1,
      "explanation": "EPOC, adaptive thermogenesis, and NEAT are all real, measured phenomena of the sizes described. The meal-frequency claim and the total starvation-mode shutdown claim are both myths not supported by the underlying physiology or the first law of thermodynamics."
    },
    {
      "id": "e1-c9-mc-1",
      "chapter": 9,
    ...
    },
    {
      ...
      "chapter": 9,
      "type": "free",
      "q": "An online coach tells a client that heavy abdominal exercises will melt the fat right off the stomach because working a muscle burns the fat stored on top of it, and separately tells the same client that skipping meals for a few days will send the body into starvation mode and stop all further progress. Using the chapter's three-question method (name the mechanism, size the effect, check whether the conclusion follows), explain in an educational, role-neutral way what is wrong with each claim, and state where your own explanation must stop.",
      "model": "Both claims name a real mechanism and then push it toward a conclusion the evidence does not support, though they fail in different ways. The spot reduction claim is a location error: contracting a muscle does burn fuel, including some fat, but the fat mobilized from adipose tissue enters a shared bloodstream governed by regional blood flow and hormone sensitivity, not by which muscle happens to be contracting nearby, so working the abdominal muscles does not preferentially drain fat stored over the abdomen. The starvation mode claim is a magnitude error: skipping meals or restricting calories does trigger a real, measurable adaptive thermogenesis, a fall in resting energy expenditure driven by falling leptin, reduced thyroid hormone conversion, and lower sympathetic tone, but its typical size in controlled studies is on the order of about one hundred kilocalories per day, a real but modest and reversible adjustment, not a shutdown that halts fat loss entirely, since energy balance still obeys the first law of thermodynamics. What this explanation can do is walk through each mechanism and show why the conclusion built on top of it outruns the evidence. What it cannot do is tell this specific client whether their own current eating pattern is safe, evaluate whether a period of severe restriction has caused a clinically significant problem, or replace an individualized nutrition or medical assessment. Anyone with persistent, severe, or worsening symptoms tied to under-eating or missed periods, unusual fatigue, or a stalled metabolism should be directed to a qualified professional rather than reasoning it out from general course material alone.",
      "key_points": [
        "Spot reduction is a location error: fat mobilized during exercise enters a shared bloodstream, not a local depot preferentially drained by the working muscle",
        "Starvation mode is a magnitude error: adaptive thermogenesis is real but typically about one hundred kilocalories per day, not a total shutdown",
        "Both claims name a real mechanism (local fuel use; adaptive thermogenesis) before inflating or misplacing the conclusion",
        "Role-neutral boundary: explain the mechanism and grade the claim, but do not assess this specific client's safety or diagnose a metabolic problem"
      ],
      "rubric": {
        "pass_threshold": 70,
        "points": [
          {
            "desc": "Correctly identifies the spot reduction claim as a location error and explains the shared-bloodstream mechanism",
            "weight": 25
          },
          {
            "desc": "Correctly identifies the starvation mode claim as a magnitude error and cites the roughly one hundred kilocalorie per day adaptive thermogenesis figure",
            "weight": 25
          },
          {
            "desc": "Applies the name-the-mechanism, size-the-effect, check-the-conclusion method explicitly to both claims",
            "weight": 25
          },
          {
            "desc": "Keeps an educational, role-neutral framing and defers individualized safety or diagnostic judgments to a qualified professional",
            "weight": 25
          }
        ]
      },
